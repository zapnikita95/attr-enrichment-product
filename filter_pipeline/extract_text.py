...
NAME_ALIASES: dict[str, str] = {
    ...
    "капюшон": "hood",
    "тип рукава/длины рукава": "sleeve_length",
    "тип рукава": "sleeve_length",
    "тип рукава/детали рукава": "sleeve_length",
    "тип воротника/выреза": "collar",
    "тип воротника": "collar",
    "тип выреза горловины": "collar",
    "тип застёжки/лямки (для купальников)": "fastener",
    "тип пряжки/застёжки": "fastener",
    "тип застежки": "fastener",
}
